...
class DarkAppColors {
  // ---------- Primary Palette ----------
  static const Color primary900 = Color(0xFF191301);
  static const Color primary800 = Color(0xFFF7A501);
  static const Color primary700 = Color(0xFFEFB33C);
  static const Color primary600 = Color(0xFFEDC26C);
  static const Color primary500 = Color(0xFFFFF6E6);
  static const Color primary400 = Color(0xFFFFEECC);
  static const Color primary300 = Color(0xFFFFFAF0);
